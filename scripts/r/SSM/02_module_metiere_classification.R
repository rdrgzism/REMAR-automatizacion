...
if (file.exists(file.path(results_dir, "sample.RData"))) {
  load(file.path(results_dir, "sample.RData"))         # OUT and journey_list
} else{
...
save(list = names(save_list), file = file.path(results_dir, "predicted.RData"))
