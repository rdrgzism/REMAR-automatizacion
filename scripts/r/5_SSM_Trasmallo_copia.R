...
input$journey <- as.character(input$journey)
...
# Save shapefile
st_write(intersected, paste0("tresmall_intersected_", metier, "_2024.shp"), delete_layer = TRUE)

cat("\n✅ State estimation and shapefile export completed for:", metier, "\n")
